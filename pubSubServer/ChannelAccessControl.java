...
public class ChannelAccessControl {
	...
	protected static ChannelAccessControl getInstance() {
		if(instance == null) instance = new ChannelAccessControl();
		return instance;
	}
	...
	protected void blockSubcriber(AbstractSubscriber subscriber, String channelName) {
		System.out.println("ChannelAccessControl :: " + subscriber + " has been blocked on Channel: " + channelName);
	...
	protected void unBlockSubscriber(AbstractSubscriber subscriber, String channelName) {
		System.out.println("ChannelAccessControl :: " + subscriber + " has been unblocked on Channel: " + channelName);
